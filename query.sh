...
curl -u galileo:g4l1l30975 -H "Content-Type: application/json" -X POST -d '
{"metrics": [{"aggregators": [{"align_sampling": true, "name": "avg", "align_start_time": true, "sampling": {"unit": "seconds", "value": 5}}], "group_by": [{"name": "tag", "tags": ["node"]}], "name": "C3res", "tags": {"node": ["node495"], "org": "cineca", "cluster": "galileo"}}], "end_absolute": 1511143023000, "cache_time": 86400, "start_absolute": 1503950177000}
' http://137.204.213.218:8083/api/v1/datapoints/query
