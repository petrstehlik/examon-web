...
'''
 ...
 TEST VERSION (to be used with pbs_python --hook -i ..)
...
homedir = '/galileo/home/userexternal/aborghes/' 
templogs_dir = homedir + 'data_collection/galileo_pbs/hooks/'
cores_info_table_dir = templogs_dir + 'cores_info_table'

info2mqtt_pyscript = homedir
